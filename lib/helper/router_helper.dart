...
//*******Handlers*********
  ...
  static Handler _menu_screen_web_hendeler = Handler(
      handlerFunc: (context, Map<String, dynamic> params) => MenuScreenWeb());
  ...
  static Handler __homeScreenHandler =
      Handler(handlerFunc: (context, Map<String, dynamic> params) {
  ...
  static Handler _categoryHandler =
    ...
    return _categoryScreen != null
        ? _categoryScreen
        : CategoryScreen(
            categoryModel: CategoryModel(id: int.parse(params['id'][0])));
  });
  ...
  static Handler _paymentHandler =
    ...
    return PaymentScreen(
        ...
        url: _fromCheckOut
            ...
            : '',
        placeOrderBody: _decoded != 'null'
            ? PlaceOrderBody.fromJson(jsonDecode(_decoded))
            : null);
  });
  ...
  static Handler _orderWebPaymentHandler =
      Handler(handlerFunc: (context, Map<String, dynamic> params) {
  ...
  static Handler _mapHandler =
    ...
    DeliveryAddress _data =
        DeliveryAddress.fromJson(jsonDecode(utf8.decode(_decode)));
  ...
  static Handler _chatHandler =
      Handler(handlerFunc: (context, Map<String, dynamic> params) {
    final _orderModel = jsonDecode(
        utf8.decode(base64Url.decode(params['order'][0].replaceAll(' ', '+'))));
    return ChatScreen(
        orderModel:
            _orderModel != null ? OrderModel.fromJson(_orderModel) : null);
  });
...
//*******Route Define*********
  static void setupRouter() {
    ...
    router.define(Routes.MAINTAIN,
        handler: _maintainHandler, transitionType: TransitionType.fadeIn);
    router.define(Routes.MENU_SCREEN_WEB,
        handler: _menu_screen_web_hendeler,
        transitionType: TransitionType.fadeIn);
    router.define(Routes.UPDATE,
        handler: _updateHandler, transitionType: TransitionType.fadeIn);
    router.define(Routes.POPULAR_ITEM_ROUTE,
        handler: _popularItemScreenHandler,
        transitionType: TransitionType.fadeIn);
  }
}
