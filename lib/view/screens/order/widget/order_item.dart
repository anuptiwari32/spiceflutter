            ...
            Expanded(
              ...
              style: TextButton.styleFrom(
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(10),
                  side:
                      BorderSide(width: 2, color: ColorResources.DISABLE_COLOR),
                ),
                        ...
                        onTap: () async {
                          if (isRunning) {
                            ...
                            orderDetails.forEach((orderDetail) {
                              ...
                              for (int i = 0;
                                  i < orderDetail.addOnIds.length;
                                  i++) {
                                _addOnList.add(AddOn(
                                    id: orderDetail.addOnIds[i],
                                    quantity: orderDetail.addOnQtys[i]));
                              }
                              ...
                              if (xyz != null && xyz.isNotEmpty) {
                                type = xyz;
                                price =
                                    double.parse(orderDetail.price.toString());
                                _variationList
                                    .add(Variation(type: type, price: price));
                              }
