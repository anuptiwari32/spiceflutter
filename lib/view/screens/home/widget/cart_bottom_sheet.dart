...
class CartBottomSheet extends StatelessWidget {
            ...
            child: Consumer<ProductProvider>(
              builder: (context, productProvider, child) {
                ...
                isExistInCart = _cartProvider.isExistInCart(
                            product.id, variationType, fromCart, cartIndex) ==
                        -1
                    ? false
                    : true;
                ...
                return SingleChildScrollView(
                  child: Column(
                      ...
                      children: [
                        //Product
                        _productView(context, _startingPrice, _endingPrice,
                        ...
                        Row(children: [
                          ...
                          _quantityButton(context, isExistInCart, _cartProvider,
                              _cartModel, productProvider),
                        ]),
                        SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                        ...
                        product.productModels.length > 0
                            ? Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                    Text(getTranslated('items', context),
                                        style: rubikMedium.copyWith(
                                            fontSize:
                                                Dimensions.FONT_SIZE_LARGE)),
                                    SizedBox(
                                    ...
                                    GridView.builder(
                                      ...
                                      shrinkWrap: true,
                                      physics: NeverScrollableScrollPhysics(),
                                      itemCount: product.productModels.length,
                                      itemBuilder: (context, index) {
                                        return InkWell(
                                          onTap: () {},
                                          child: Stack(
                                            children: [
                                              ClipRRect(
                                                ...
                                                child: FadeInImage.assetNetwork(
                                                  ...
                                                  fit: BoxFit.cover,
                                                  image:
                                                      '${Provider.of<SplashProvider>(context, listen: false).baseUrls.productImageUrl}/${product.productModels[index].image}',
                                                  imageErrorBuilder:
                                                      (c, o, s) => Image.asset(
                                                          Images
                                                              .placeholder_image,
                        ...
                        ResponsiveHelper.isDesktop(context)
                            ...
                            ResponsiveHelper.isDesktop(context)
                                ? SizedBox(
                                    width: size.width / 2.0,
                                    child: _cartButton(_isAvailable, context,
                                        isExistInCart, _cartModel),
                                  )
                                : _cartButton(_isAvailable, context,
                                    isExistInCart, _cartModel),
                      ]),
                );
              },
  ...
  Column _cartButton(bool _isAvailable, BuildContext context,
      bool isExistInCart, CartModel _cartModel) {
  ...
  Row _productView(BuildContext context, double _startingPrice,
      double _endingPrice, double price, double priceWithDiscount) {
    return Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
